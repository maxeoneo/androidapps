package com.maxeoneo.antitheftprotection.data;
...
public class UsbReceiver extends BroadcastReceiver
{
  ...
  {
      System.out.println("### USB disconnected - starting alarm");
...
//  }
  ...
  private class AlarmThread extends Thread
  {
    ...
    public void run()
    {
        System.out.println("### Alarm thread started");
      ...
      {
          System.out.println("### Lock is active, starting alarm");
        setVolumeToMax();
        alarmSound.start();
